# Telco Customer Churn guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `Telco Customer Churn/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `Telco Customer Churn` folder and use the modules inside your notebooks :
...
```python
from Telco Customer Churn.utils.paths import data_dir
data_dir()
```
