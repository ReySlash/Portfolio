    ...
    def __init__(self):
        ...
        self.params = {
            ...
            'random_forest': {
                ...
                'model__max_depth': list(range(2,20,4)),        # Maximum depth of the trees
            ...
            'lightgbm': {
                'pca__n_components': [None],
                'model__verbosity': [-1],
                'model__num_leaves': [13, 15, 25, 29, 33],                          # Number of leaves controls the model's complexity.
                'model__max_depth': [-1, 5, 15, 20, 25],                           # -1 allows unlimited depth.
                'model__learning_rate': [0.07, 0.1, 0.13, 0.17, 0.2],       # Learning rate adjusts the step size during training. Lower values improve generalization, while higher values converge faster.
                'model__n_estimators': [25, 50, 75, 100, 125],              # Number of boosting iterations. Higher values allow deeper learning at the cost of computation time.
                'model__class_weight': [None, 'balanced'],                  # Handle imbalanced classes
                }
        }       
