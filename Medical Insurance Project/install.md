# Medical_Insurance_Project guide installation
...
activate medical_insurance_project
```
...
To move beyond notebook prototyping, all reusable code should go into the `medical_insurance_project/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `medical_insurance_project` folder and use the modules inside your notebooks :
...
```python
from medical_insurance_project.utils.paths import data_dir
data_dir()
```
